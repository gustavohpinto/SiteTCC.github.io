...
<body>
    ...
    <section class="espaco" style="padding-top: 5%; padding-bottom: 10%; padding-right: 20%; padding-left: 20%; align-items: center;">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="card">
                        <form action="insere_ganho.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
